...
async function executeEnhancedGeneration(payload) {
  ...
  try {
    ...
    const saasGenerator2 = new SaaSGenerator();
    ...
    switch (generationType) {
      case "full-stack-saas":
        ...
        const saasResult = await saasGenerator2.generate(job.prompt, jobId, callbacks);
      ...
      case "full-saas":
        ...
        const saasOnlyResult = await saasGenerator2.generate(job.prompt, jobId, callbacks);

...
var prisma = globalForPrisma.prisma ?? new import_client3.PrismaClient({
...
// src/lib/generation/bolt-generator.ts
var SYSTEM_PROMPT = `You are an expert full-stack developer. You generate complete, working Next.js applications.
...
function validateGeneratedFiles(files) {
  ...
  return requiredFiles.filter((f) => !generatedPaths.has(f));
}
__name(validateGeneratedFiles, "validateGeneratedFiles");
  ...
  run: /* @__PURE__ */ __name(async (payload) => {
    ...
    try {
      ...
      const result = await generator.generate(job.prompt, jobId, {
        ...
        onFileComplete: /* @__PURE__ */ __name((path2) => {
          logger.info(`✅ Generated: ${path2}`);
        }, "onFileComplete"),

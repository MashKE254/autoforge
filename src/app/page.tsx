// We haven't installed these components yet, but we're
// planning for them. We will add them in the next steps.
    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-24">
      ...
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        <p className="fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-linear-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto  lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30">
          Welcome to&nbsp;
          <code className="font-mono font-bold">AutoForge</code>
        </p>
      ...
      <div className="mb-32 mt-16 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left">
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
            Create complex, production-ready SaaS applications from a single prompt.
          </p>
        </div>
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
            Instantly deploy your application to a global edge network.
          </p>
        </div>
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
            Start earning revenue in minutes with built-in subscription management.
          </p>
        </div>
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
            Our platform learns from every build, improving for all users.
          </p>
        </div>
      </div>
    </main>
